...
export default function ContactPage() {
  ...
  useEffect(() => {
    const fetchContactInfo = async () => {
      try {
        ...
        const data = await client.fetch(`*[_type == "contactInfoBox"][0]`);
  ...
  console.log("Current contactInfo state:", contactInfo);
                    ...
                    <>
                      <p className="flex items-start space-x-4 text-gray-600">
                        {contactInfo.addressIcon && (
                          <Image
                            src={urlFor(contactInfo.addressIcon).url()}
                            alt="Address Icon"
                            width={24}
                            height={24}
                      ...
                      <p className="flex items-start space-x-4 text-gray-600">
                        {contactInfo.emailIcon && (
                          <Image
                            src={urlFor(contactInfo.emailIcon).url()}
                            alt="Email Icon"
                            width={24}
                            height={24}
                            className="text-gray-400"
                      ...
                      <p className="flex items-start space-x-4 text-gray-600">
                        {contactInfo.phoneIcon && (
                          <Image
                            src={urlFor(contactInfo.phoneIcon).url()}
                            alt="Phone Icon"
                            width={24}
                            height={24}
                            className="text-gray-400"
