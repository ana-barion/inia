export default function Home() {
  return (
    <main>
      ...
      <p>
        The Inhibitor Mechanism works by suppressing excessive immune activity, which helps reduce
        inflammation and prevent conditions such as organ transplant rejection and autoimmune
        disorders. It employs ultrasound or electrical stimulation to lower pro-inflammatory
        cytokines, such as TNF-α and IL-6. This mechanism specifically targets the vagus nerve and
        other key neural pathways involved in immune regulation.
      </p>

      <p>
        In contrast, the Engager Mechanism activates immune pathways to enhance immune function,
        which is particularly beneficial for immunodeficiency disorders or chronic infections. It
        stimulates immune cells to increase anti-inflammatory cytokines, such as IL-10, which aids
        in tissue repair and promotes homeostasis.
      </p>

      <p>
        INIA Biosciences integrates the Inhibitor/Engager Mechanism into its non-invasive,
        ultrasound-based device for immune modulation. Their system monitors biomarkers such as
      ...
      <ul>
        <li>
          <strong>Non-Invasive Ultrasound Therapy:</strong> Uses targeted sound waves to stimulate
          neural pathways that regulate immune function without requiring surgery or implanted
          devices.
        </li>
        <li>
          <strong>Closed-Loop Monitoring:</strong> Continuously monitors biomarkers (e.g.,
          inflammation levels) and adjusts stimulation parameters for personalized immune
          modulation.
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              responses in chronic infections or immunodeficiency disorders.
            </li>
          </ul>
        </li>
        <li>
